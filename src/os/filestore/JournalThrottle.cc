...
uint64_t JournalThrottle::take(uint64_t c) { return throttle.take(c); }
...
uint64_t JournalThrottle::get_current() { return throttle.get_current(); }

uint64_t JournalThrottle::get_max() { return throttle.get_max(); }
